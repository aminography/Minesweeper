 ...
 */
public class FirstThemeEmptyCellViewHolder extends BaseEmptyCellViewHolder {

    private static final int LAYOUT_RESOURCE_ID = R.layout.test_cell_item;

    public FirstThemeEmptyCellViewHolder(LayoutInflater layoutInflater, ViewGroup parent, int cellWidth) {
