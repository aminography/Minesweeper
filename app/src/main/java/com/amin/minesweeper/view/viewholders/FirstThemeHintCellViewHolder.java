 ...
 */
public class FirstThemeHintCellViewHolder extends BaseHintCellViewHolder {

    private static final int LAYOUT_RESOURCE_ID = R.layout.test_cell_item;

    public FirstThemeHintCellViewHolder(LayoutInflater layoutInflater, ViewGroup parent, int cellWidth) {
