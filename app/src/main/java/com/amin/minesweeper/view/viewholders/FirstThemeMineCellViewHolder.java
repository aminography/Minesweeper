 ...
 */
public class FirstThemeMineCellViewHolder extends BaseMineCellViewHolder {

    private static final int LAYOUT_RESOURCE_ID = R.layout.test_cell_item;

    public FirstThemeMineCellViewHolder(LayoutInflater layoutInflater, ViewGroup parent, int cellWidth) {
